...
gulp.task('scripts', function() {
  return gulp.src([
    ...
    'src/js/jquery.event.move.js', // Always at the end
    'src/js/jquery.twentytwenty.js', // Always at the end
...
if (gulpversion == 4) {
  gulp.task('watch', () => {
    ...
    global.watch = true;
    gulp.watch('src/pug/**/*.pug', gulp.series('pug'), gulp.parallel('pug')).on('all', (event, filepath) => {global.emittyChangedFile = filepath;});
    gulp.watch(['src/scss/**/*.'+syntax+'', 'src/scss/**/*.'+syntax+''], gulp.parallel('styles'));
